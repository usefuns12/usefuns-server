        ...
        if (
          ...
          try {
            ...
            if (categoryName === "surprise") {
              console.log(
                "🎲 Surprise gift detected, applying special logic..."
              );
              ...
              if (shouldGiveCashback) {
                ...
                console.log(
                  "📊 Aggregating GiftTransactions in last 5 mins..."
                );
            ...
            const totalDiamondsUsed =
              room.totalDiamondsUsed + totalGiftDiamonds;
